...
- [First MIPT term projects](https://github.com/Shishqa/MIPT_1sem_C_lang):
  - Simple virtual machine
  - Derivative calculator
  - C-like language compiler
- [Second MIPT term projects](https://github.com/Shishqa/MIPT_2sem_Assembly):
  - Hash table optimized with assembly inserts
  - Binary translator from Virtual machine binaries to ELF x86_64
